#!/bin/bash
#
# Start script for strike-off-partner-objections-processor service
...
exec java ${JAVA_MEM_ARGS} -jar ${PROXY_ARGS} -Dserver.port="${PORT}" "${APP_DIR}/strike-off-partner-objections-processor.jar"