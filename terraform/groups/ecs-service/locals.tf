...
locals {
  ...
  lb_listener_rule_priority  = 52                                                     # priority for the lb listener rule to route to this service, must be unique across services using the same load balancer listener
